...
**Date:** 2026-09-06 (🆕 **A SECOND PROGRAMME IS OPEN: V29 systematic value, pre-registration SIGNED, K 0/3, nothing read.** 🔑 **The survivorship fix was aimed at the smaller bias — correcting it ADDS 15 events; the liquidity screen's look-ahead REMOVES 590, 32% of spec #3's event set.** 🔴 **The Referee was enforcing v27's K=5 on V29's K=3 registry and the status line looked normal.** ⚠️ **Declared costs of 75 bps measure at 106-210 bps; the parameter is signed and does not move.** v27 K **2/5**, V29 K **0/3**. Live pipeline untouched.)
**Branch:** `master` (live/cron) · v29 work on `v29/fundamentals` (PR #69), v27 step 3 on `v27/events-pit` (PR #68)  
