...
**Last commit:** `2d4d116` (2026-09-05 — `Auto: evening cycle 18:30 UTC`; the live crons are still writing daily). *Last human/structural commit on master:* `15027a9` (v27 step 2, point-in-time universe). `predictions.csv` = **53447** rows.
