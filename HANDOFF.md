...
| **Exits** | ✅ **Still run.** The cap is BUY-only (`quant_runner.py:5723`); SELLs use `_oversell_cap` (:5726). ✅ **BOOK IS FLAT as of 2026-09-01** — HON was covered, `open_shorts: []`, `short_acked: []`, `flat: true`. The gate prints `OK — armed and flat (book=0)` and the 21-day red streak is over. |
