...
- 🔴 **GitHub runner-acquisition failures (④) — FIVE tonight; they delayed ⑥'s merge by ~1h but did not block it.** Two validate dispatches died before a sixth landed a runner: `validate ALL PASS 31128790805`, merged `b3604a2`. **If the 8/07 13:35Z morning dispatch also fails to acquire a runner, that is a real evidence gap across all three clocks** — and Frame-3 is ~4 obs from its ≥30 decision-grade read. Watch it first thing.
